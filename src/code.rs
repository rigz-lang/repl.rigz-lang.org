...
pub fn CodeEditor(
    ...
    view! {
        <div class="container min-h-[450px] w-full lg:w-[60vw] border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 ">
